...
if(empty($Title)){
	...
	if($Execute){
	$_SESSION["SuccessMessage"]="Votre publication a ete actualise avec success.";
	Redirect_to("Dashboard.php");
	}else{
	$_SESSION["ErrorMessage"]="Il y a eu un probleme, Veuillez essayer de nouveau.";
	Redirect_to("Dashboard.php");
              ...
              <button class="btn btn-sm btn-outline-secondary dropdown-toggle">
           	...
           	<div class="col-sm-10">
						...
						<div>
							...
							<?php
							$SearchQueryParameter=$_GET['Editer'];
							$ConnectingDB;
							...
							?>
				<form action="EditerPost.php?Editer=<?php echo $SearchQueryParameter; ?>" method="post" enctype="multipart/form-data">
					<fieldset>
...
?>	
	...
	<textarea class="form-control" name="Post" id="postarea"></textarea>
		<?php echo $PostToBeUpdated; ?>
						<br>
						<input class="btn btn-info" type="Submit" name="Submit" value="Actualiser un poste">
					</fieldset>
					<br>
				</form>
				</div>
